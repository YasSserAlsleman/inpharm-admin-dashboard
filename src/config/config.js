...
// export const BASE_API_URL = import.meta.env.VITE_API_URL || 'http://192.168.1.8:5000/api';  // للـ API (من axiosClient.js)
// export const BASE_FILE_URL = import.meta.env.VITE_FILE_URL || 'http://192.168.1.8:5000';