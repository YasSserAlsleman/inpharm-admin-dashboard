  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md space-y-6">
      ...
      <PeopleSection
        ...
        onAdd={() =>
          setAbout({ ...about, management: [...about.management, { name: "", info: "", imageUrl: "" }] })
        }
        onChange={(i, f, v) => {
      ...
      <PeopleSection
        ...
        onAdd={() =>
          setAbout({
            ...about,
            teachingStaff: [...about.teachingStaff, { name: "", info: "", imageUrl: "" }],
          })
        }
        onChange={(i, f, v) => {
...
<div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
    {Object.keys(about.contact)
      .filter((key) => key !== "_id") // 🔹 استبعاد حقل id من العرض
      .map((key) => (
        <input
          key={key}
          type="text"
          placeholder={`رابط ${key}`}
          value={about.contact[key]}
          onChange={(e) =>
            setAbout({
              ...about,
