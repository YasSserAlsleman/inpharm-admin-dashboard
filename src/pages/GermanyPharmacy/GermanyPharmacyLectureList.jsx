...
export default function GermanyPharmacyLectureList() {
  ...
  const fetchResearchAndLectures = async () => {
    try {
      ...
      const [researchRes, lectureRes] = await Promise.all([
        axios.get(`/germanyPharmacyResearch/${researchId}`),
              ...
              <tr key={lecture._id} {...dragProps} className="border-t hover:bg-gray-50">
                ...
                <td className="p-2 text-center">
                  <div className="flex justify-center gap-2">
                    <button
                      onClick={() => navigate(`/germanyPharmacyLecture/${lecture._id}/lessons`, {
