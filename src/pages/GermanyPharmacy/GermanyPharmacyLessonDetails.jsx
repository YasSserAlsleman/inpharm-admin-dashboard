...
export default function GermanyPharmacyLessonDetails() {
  ...
  const handleSaveRelatedLessons = async (selected) => {
    try {
      await axios.put(`/germanyPharmacyLesson/${lessonId}/relatedLessons`, {
  ...
  const handleDeleteComment = async (commentId) => {
    if (!window.confirm(t('lessons.confirmDeleteCommentMessage'))) return;
    try {
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditedLesson({
                      ...editedLesson,
                      pdfFileUpload_ar: e.target.files[0],
                    })
                  }
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditedLesson({
                      ...editedLesson,
                      pdfFileUpload_en: e.target.files[0],
                    })
                  }
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditedLesson({
                      ...editedLesson,
                      pdfFileUpload_de: e.target.files[0],
                    })
                  }
                />
              </div>
                          ...
                          <p className="text-xs text-gray-600">
                            {related.lessonType === "learning"
                              ...
                              : related.lessonType === "podcast"
                                ? " درس بودكاست"
                                : related.lessonType=== "germanyPharmacy" ? " درس صيدلية في ألمانيا" : "درس صيدلية"}
                          </p>
                        </div>
                      </div>
                    ))}
