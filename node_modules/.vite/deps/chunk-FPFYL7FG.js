...
function useAutocomplete(props) {
  ...
  const [focusedItem, setFocusedItem] = React4.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React4.useRef(defaultHighlighted);
  const initialInputValue = React4.useRef(getInputValue(defaultValue ?? valueProp, multiple, getOptionLabel)).current;
  ...
  const resetInputValue = React4.useCallback((event, newValue, reason) => {
  ...
  const handleFocusItem = (event, direction) => {
    ...
    if (focusedItem === -1 && direction === "previous") {
      ...
      if (nextItem3 === value.length) {
        nextItem3 = -1;
      }
    }
    nextItem3 = validItemIndex(nextItem3, direction);
    setFocusedItem(nextItem3);
    focusItem(nextItem3);
  };
...
var LazyRipple = class _LazyRipple {
  ...
  static use() {
    ...
    const [shouldMount, setShouldMount] = React14.useState(false);
    ripple.shouldMount = shouldMount;
    ripple.setShouldMount = setShouldMount;
    React14.useEffect(ripple.mountEffect, [shouldMount]);
    return ripple;
  }
  mount() {
    if (!this.mounted) {
...
function Ripple(props) {
  ...
  return (0, import_jsx_runtime9.jsx)("span", {
    ...
    style: rippleStyles,
    children: (0, import_jsx_runtime9.jsx)("span", {
...
`;
var TouchRipple = React22.forwardRef(function TouchRipple2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTouchRipple"
  });
  ...
  const startCommit = React22.useCallback((params) => {
    ...
    setRipples((oldRipples) => [...oldRipples, (0, import_jsx_runtime10.jsx)(TouchRippleRipple, {
      classes: {
  ...
  return (0, import_jsx_runtime10.jsx)(TouchRippleRoot, {
    className: clsx_default(touchRippleClasses_default.root, classes.root, className),
    ref: container,
    ...other,
    children: (0, import_jsx_runtime10.jsx)(TransitionGroup_default, {
      component: null,
      exit: true,
      children: ripples
    })
...
var ButtonBase = React23.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  return (0, import_jsx_runtime11.jsxs)(ButtonBaseRoot, {
    as: ComponentProp,
    className: clsx_default(classes.root, className),
    ownerState,
    onBlur: handleBlur,
    ...
    ...buttonProps,
    ...other,
    children: [children2, enableTouchRipple ? (0, import_jsx_runtime11.jsx)(TouchRipple_default, {
      ref: handleRippleRef,
      center: centerRipple,
      ...TouchRippleProps
    }) : null]
...
true ? ButtonBase.propTypes = {
   ...
   * @ignore
   */
  formAction: import_prop_types17.default.oneOfType([import_prop_types17.default.func, import_prop_types17.default.string]),
  /**
   * @ignore
   */
...
var CircularProgress = React24.forwardRef(function CircularProgress2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiCircularProgress"
  });
  ...
  return (0, import_jsx_runtime12.jsx)(CircularProgressRoot, {
    className: clsx_default(classes.root, className),
    style: {
      width: size,
      height: size,
    ...
    ...rootProps,
    ...other,
    children: (0, import_jsx_runtime12.jsxs)(CircularProgressSVG, {
      className: classes.svg,
      ownerState,
      viewBox: `${SIZE / 2} ${SIZE / 2} ${SIZE} ${SIZE}`,
      children: [enableTrackSlot ? (0, import_jsx_runtime12.jsx)(CircularProgressTrack, {
        ...
        "aria-hidden": "true"
      }) : null, (0, import_jsx_runtime12.jsx)(CircularProgressCircle, {
...
var IconButton = React25.forwardRef(function IconButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiIconButton"
  });
  ...
  const loadingIndicator = loadingIndicatorProp ?? (0, import_jsx_runtime13.jsx)(CircularProgress_default, {
  ...
  return (0, import_jsx_runtime13.jsxs)(IconButtonRoot, {
    ...
    (0, import_jsx_runtime13.jsx)("span", {
      ...
      children: (0, import_jsx_runtime13.jsx)(IconButtonLoadingIndicator, {
...
true ? IconButton.propTypes = {
  ...
  children: chainPropTypes(import_prop_types19.default.node, (props) => {
    const found = React25.Children.toArray(props.children).some((child) => React25.isValidElement(child) && child.props.onClick);
    if (found) {
...
var Chip = React26.forwardRef(function Chip2(inProps, ref) {
  ...
  return (0, import_jsx_runtime15.jsxs)(RootSlot, {
    as: component,
    ...rootProps,
    children: [avatar || icon, (0, import_jsx_runtime15.jsx)(LabelSlot, {
      ...labelProps,
      children: label
    }), deleteIcon]
  });
...
var TextareaAutosize = React27.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime16.jsxs)(React27.Fragment, {
...
var Autocomplete = React31.forwardRef(function Autocomplete2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiAutocomplete"
  });
  ...
  return (0, import_jsx_runtime20.jsxs)(React31.Fragment, {
    children: [(0, import_jsx_runtime20.jsx)(AutocompleteRoot, {
      ref,
      className: clsx_default(classes.root, className),
      ownerState,
      ...getRootProps(other),
        ...
        InputProps: {
          ...
          ...(hasClearIcon || hasPopupIcon) && {
            endAdornment: (0, import_jsx_runtime20.jsxs)(AutocompleteEndAdornment, {
              ...
              ownerState,
              children: [hasClearIcon ? (0, import_jsx_runtime20.jsx)(AutocompleteClearIndicator, {
                ...getClearProps(),
                ...
                children: clearIcon
              }) : null, hasPopupIcon ? (0, import_jsx_runtime20.jsx)(AutocompletePopupIndicator, {
                ...getPopupIndicatorProps(),
                disabled,
    ...
    }), anchorEl ? (0, import_jsx_runtime20.jsx)(AutocompletePopper, {
      as: PopperSlot,
      ...popperProps,
      children: (0, import_jsx_runtime20.jsxs)(AutocompletePaper, {
        as: PaperSlot,
        ...paperProps,
        ...
        }) : null, groupedOptions.length > 0 ? (0, import_jsx_runtime20.jsx)(ListboxSlot, {
...
var BadgeBadge = styled_default("span", {
  ...
  variants: [...Object.entries(theme.palette).filter(createSimplePaletteValueFilter(["contrastText"])).map(([color]) => ({
    ...
    style: ({
      ...
      const offset2 = ownerState.overlap === "circular" ? "14%" : 0;
      return {
        "--Badge-translateX": horizontal === "right" ? "50%" : "-50%",
        "--Badge-translateY": vertical === "top" ? "-50%" : "50%",
        top: vertical === "top" ? offset2 : "initial",
        bottom: vertical === "bottom" ? offset2 : "initial",
        right: horizontal === "right" ? offset2 : "initial",
        left: horizontal === "left" ? offset2 : "initial",
...
var Badge = React32.forwardRef(function Badge2(inProps, ref) {
  ...
  return (0, import_jsx_runtime21.jsxs)(RootSlot, {
    ...rootProps,
    children: [children2, (0, import_jsx_runtime21.jsx)(BadgeSlot, {
      ...badgeProps,
...
true ? Badge.propTypes = {
  ...
  anchorOrigin: import_prop_types24.default.shape({
    horizontal: import_prop_types24.default.oneOf(["left", "right"]),
    vertical: import_prop_types24.default.oneOf(["bottom", "top"])
  }),
  /**
...
var SwitchBase = React33.forwardRef(function SwitchBase2(props, ref) {
  ...
  return (0, import_jsx_runtime22.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [(0, import_jsx_runtime22.jsx)(InputSlot, {
      ...inputSlotProps
...
var Divider = React35.forwardRef(function Divider2(inProps, ref) {
  ...
  return (0, import_jsx_runtime27.jsx)(DividerRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    role,
    ref,
    ...
    ...other,
    children: children2 ? (0, import_jsx_runtime27.jsx)(DividerWrapper, {
...
var elementAcceptingRef = chainPropTypes(import_prop_types28.default.element, acceptingRef);
elementAcceptingRef.isRequired = chainPropTypes(import_prop_types28.default.element.isRequired, acceptingRef);
...
function FocusTrap(props) {
  ...
  const ignoreNextEnforceFocus = React36.useRef(false);
  const sentinelStart = React36.useRef(null);
  const sentinelEnd = React36.useRef(null);
  const nodeToRestore = React36.useRef(null);
  const reactFocusEventTarget = React36.useRef(null);
  const activated = React36.useRef(false);
  const rootRef = React36.useRef(null);
  const handleRef = useForkRef(getReactElementRef(children2), rootRef);
  const lastKeydown = React36.useRef(null);
  React36.useEffect(() => {
  ...
  return (0, import_jsx_runtime28.jsxs)(React36.Fragment, {
    children: [(0, import_jsx_runtime28.jsx)("div", {
      tabIndex: open ? 0 : -1,
      onFocus: handleFocusSentinel,
      ref: sentinelStart,
      "data-testid": "sentinelStart"
    }), React36.cloneElement(children2, {
      ref: handleRef,
      onFocus
...
var LinearProgress = React37.forwardRef(function LinearProgress2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiLinearProgress"
  });
...
var ListItemIcon = React39.forwardRef(function ListItemIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime30.jsx)(ListItemIconRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var Typography = React40.forwardRef(function Typography2(inProps, ref) {
  ...
  return (0, import_jsx_runtime31.jsx)(TypographyRoot, {
    as: Component,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
true ? Typography.propTypes = {
   ...
   * [palette customization guide](https://mui.com/material-ui/customization/palette/#custom-colors).
   */
  color: import_prop_types32.default.oneOfType([import_prop_types32.default.oneOf(["primary", "secondary", "success", "error", "info", "warning", "textPrimary", "textSecondary", "textDisabled"]), import_prop_types32.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
...
var ListItemText = React41.forwardRef(function ListItemText2(inProps, ref) {
  ...
  if (primary != null && primary.type !== Typography_default && !disableTypography) {
    primary = (0, import_jsx_runtime32.jsx)(PrimarySlot, {
  ...
  if (secondary != null && secondary.type !== Typography_default && !disableTypography) {
    secondary = (0, import_jsx_runtime32.jsx)(SecondarySlot, {
      variant: "body2",
      color: "textSecondary",
      ...secondarySlotProps,
      children: secondary
...
true ? ListItemText.propTypes = {
   ...
   */
  primary: import_prop_types33.default.node,
  /**
   * These props will be forwarded to the primary typography component
   * (as long as disableTypography is not `true`).
   * @deprecated Use `slotProps.primary` instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   */
  primaryTypographyProps: import_prop_types33.default.object,
  /**
   * The secondary content element.
   */
  secondary: import_prop_types33.default.node,
  /**
   * These props will be forwarded to the secondary typography component
   * (as long as disableTypography is not `true`).
   * @deprecated Use `slotProps.secondary` instead. This prop will be removed in a future major release. See [Migrating from deprecated APIs](/material-ui/migration/migrating-from-deprecated-apis/) for more details.
   */
  secondaryTypographyProps: import_prop_types33.default.object,
  /**
   * The props used for each slot inside.
   * @default {}
   */
  slotProps: import_prop_types33.default.shape({
    primary: import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object]),
    root: import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object]),
    secondary: import_prop_types33.default.oneOfType([import_prop_types33.default.func, import_prop_types33.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types33.default.shape({
    primary: import_prop_types33.default.elementType,
    root: import_prop_types33.default.elementType,
    secondary: import_prop_types33.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var List = React42.forwardRef(function List2(inProps, ref) {
  ...
  return (0, import_jsx_runtime33.jsx)(ListContext_default.Provider, {
    value: context,
    children: (0, import_jsx_runtime33.jsxs)(ListRoot, {
      as: component,
      className: clsx_default(classes.root, className),
      ref,
      ownerState,
...
var MenuList = React43.forwardRef(function MenuList2(props, ref) {
  const {
    // private
  ...
  React43.Children.forEach(children2, (child, index) => {
  ...
  const items = React43.Children.map(children2, (child, index) => {
    if (index === activeItemIndex) {
      ...
      return React43.cloneElement(child, newChildProps);
    }
    return child;
  });
...
var MenuItem = React44.forwardRef(function MenuItem2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiMenuItem"
  });
  ...
  return (0, import_jsx_runtime35.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime35.jsx)(MenuItemRoot, {
      ref: handleRef,
      role,
      tabIndex,
      component,
...
var Input = React45.forwardRef(function Input2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiInput"
  });
...
var FilledInput = React46.forwardRef(function FilledInput2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiFilledInput"
  });
...
var OutlinedInput = React47.forwardRef(function OutlinedInput2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiOutlinedInput"
  });
  ...
  const [NotchedSlot, notchedProps] = useSlot("notchedOutline", {
    ...
    additionalProps: {
      label: label != null && label !== "" && fcs.required ? (0, import_jsx_runtime39.jsxs)(React47.Fragment, {
        children: [label, " ", "*"]
      }) : label
    }
  });
  return (0, import_jsx_runtime39.jsx)(InputBase_default, {
    ...
    slotProps,
    renderSuffix: (state) => (0, import_jsx_runtime39.jsx)(NotchedSlot, {
      ...notchedProps,
...
var FormLabel = React48.forwardRef(function FormLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime40.jsxs)(FormLabelRoot, {
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref,
    ...other,
    children: [children2, fcs.required && (0, import_jsx_runtime40.jsxs)(AsteriskComponent, {
      ownerState,
      "aria-hidden": true,
...
var InputLabel = React49.forwardRef(function InputLabel2(inProps, ref) {
  const props = useDefaultProps({
    name: "MuiInputLabel",
    props: inProps
  });
  ...
  return (0, import_jsx_runtime41.jsx)(InputLabelRoot, {
    "data-shrink": shrink,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
var FormControl = React50.forwardRef(function FormControl2(inProps, ref) {
  ...
  const [adornedStart, setAdornedStart] = React50.useState(() => {
    ...
    if (children2) {
      React50.Children.forEach(children2, (child) => {
...
var FormHelperText = React51.forwardRef(function FormHelperText2(inProps, ref) {
  ...
  return (0, import_jsx_runtime43.jsx)(FormHelperTextRoot, {
    ...
    children: children2 === " " ? (
      // notranslate needed while Google Translate will not fix zero-width space issue
      _span2 || (_span2 = (0, import_jsx_runtime43.jsx)("span", {
        className: "notranslate",
        "aria-hidden": true,
        children: "​"
      }))
...
var Fade = React53.forwardRef(function Fade2(props, ref) {
  const theme = useTheme();
  ...
  return (0, import_jsx_runtime45.jsx)(TransitionComponent, {
    ...
    children: (state, {
      ...
      return React53.cloneElement(children2, {
        style: {
          opacity: 0,
          visibility: state === "exited" && !inProp ? "hidden" : void 0,
          ...styles3[state],
...
var Backdrop = React54.forwardRef(function Backdrop2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiBackdrop"
  });
  ...
  return (0, import_jsx_runtime46.jsx)(TransitionSlot, {
    in: open,
    timeout: transitionDuration,
    ...other,
    ...transitionProps,
    children: (0, import_jsx_runtime46.jsx)(RootSlot, {
      "aria-hidden": true,
      ...rootProps,
      ref,
      children: children2
...
var Modal = React56.forwardRef(function Modal2(inProps, ref) {
  ...
  return (0, import_jsx_runtime47.jsx)(Portal_default, {
    ref: portalRef,
    container,
    disablePortal,
    children: (0, import_jsx_runtime47.jsxs)(RootSlot, {
      ...rootProps,
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime47.jsx)(BackdropSlot, {
        ...backdropProps
      }) : null, (0, import_jsx_runtime47.jsx)(FocusTrap_default, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
var Popover = React57.forwardRef(function Popover2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPopover"
  });
...
var Menu = React58.forwardRef(function Menu2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiMenu"
  });
  ...
  let activeItemIndex = -1;
  React58.Children.map(children2, (child, index) => {
...
var NativeSelectInput = React59.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime50.jsxs)(React59.Fragment, {
    children: [(0, import_jsx_runtime50.jsx)(NativeSelectSelect, {
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref,
      ...other
    }), props.multiple ? null : (0, import_jsx_runtime50.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var SelectInput = React60.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime51.jsxs)(React60.Fragment, {
    children: [(0, import_jsx_runtime51.jsx)(SelectSelect, {
      as: "div",
    ...
    }), (0, import_jsx_runtime51.jsx)(SelectNativeInput, {
      "aria-invalid": error,
      ...
      ...other,
      ownerState
    }), (0, import_jsx_runtime51.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime51.jsx)(Menu_default, {
      id: `menu-${name || ""}`,
...
var Select = React61.forwardRef(function Select2(inProps, ref) {
  ...
  const InputComponent = input || {
    standard: (0, import_jsx_runtime52.jsx)(StyledInput, {
      ownerState
    }),
    outlined: (0, import_jsx_runtime52.jsx)(StyledOutlinedInput, {
      label,
      ownerState
    }),
    filled: (0, import_jsx_runtime52.jsx)(StyledFilledInput, {
      ownerState
    })
  }[variant];
  const inputComponentRef = useForkRef_default(ref, getReactElementRef(InputComponent));
  return (0, import_jsx_runtime52.jsx)(React61.Fragment, {
...
var TextField = React62.forwardRef(function TextField2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTextField"
  });
  ...
  const InputElement = (0, import_jsx_runtime53.jsx)(InputSlot, {
  ...
  return (0, import_jsx_runtime53.jsxs)(RootSlot, {
    ...rootProps,
    children: [label != null && label !== "" && (0, import_jsx_runtime53.jsx)(InputLabelSlot, {
      htmlFor: id,
      id: inputLabelId,
      ...inputLabelProps,
      children: label
    }), select ? (0, import_jsx_runtime53.jsx)(SelectSlot, {
      "aria-describedby": helperTextId,
      id,
      ...
      ...selectProps,
      children: children2
    }) : InputElement, helperText && (0, import_jsx_runtime53.jsx)(FormHelperTextSlot, {
      id: helperTextId,
      ...formHelperTextProps,
      children: helperText
    })]
...
true ? TextField.propTypes = {
   ...
   */
  FormHelperTextProps: import_prop_types54.default.object,
  /**
   * If `true`, the input will take up the full width of its container.
   * @default false
   */
   ...
   */
  helperText: import_prop_types54.default.node,
  /**
   * The id of the `input` element.
   ...
   */
  InputLabelProps: import_prop_types54.default.object,
  /**
   * [Attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/input#attributes) applied to the `input` element.
   ...
   * @default false
   */
  select: import_prop_types54.default.bool,
  /**
  ...
  slotProps: import_prop_types54.default.shape({
    formHelperText: import_prop_types54.default.oneOfType([import_prop_types54.default.func, import_prop_types54.default.object]),
    htmlInput: import_prop_types54.default.oneOfType([import_prop_types54.default.func, import_prop_types54.default.object]),
    input: import_prop_types54.default.oneOfType([import_prop_types54.default.func, import_prop_types54.default.object]),
    inputLabel: import_prop_types54.default.oneOfType([import_prop_types54.default.func, import_prop_types54.default.object]),
    select: import_prop_types54.default.oneOfType([import_prop_types54.default.func, import_prop_types54.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types54.default.shape({
    formHelperText: import_prop_types54.default.elementType,
    htmlInput: import_prop_types54.default.elementType,
    input: import_prop_types54.default.elementType,
    inputLabel: import_prop_types54.default.elementType,
    root: import_prop_types54.default.elementType,
    select: import_prop_types54.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var FormControlLabel = React63.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  if (label != null && label.type !== Typography_default && !disableTypography) {
    label = (0, import_jsx_runtime54.jsx)(TypographySlot, {
      component: "span",
      ...typographySlotProps,
  ...
  return (0, import_jsx_runtime54.jsxs)(FormControlLabelRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other,
    children: [React63.cloneElement(control, controlProps), required ? (0, import_jsx_runtime54.jsxs)("div", {
      children: [label, (0, import_jsx_runtime54.jsxs)(AsteriskComponent2, {
        ownerState,
        "aria-hidden": true,
        className: classes.asterisk,
        children: [" ", "*"]
...
var Switch = React64.forwardRef(function Switch2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiSwitch"
  });
  ...
  const icon = (0, import_jsx_runtime55.jsx)(ThumbSlot, {
    ...thumbSlotProps
  });
  ...
  return (0, import_jsx_runtime55.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [(0, import_jsx_runtime55.jsx)(SwitchSwitchBase, {
      type: "checkbox",
      icon,
      checkedIcon: icon,
      ref,
    ...
    }), (0, import_jsx_runtime55.jsx)(TrackSlot, {
      ...trackSlotProps
    })]
  });
});
true ? Switch.propTypes = {
  ...
  slotProps: import_prop_types56.default.shape({
    ...
    switchBase: import_prop_types56.default.oneOfType([import_prop_types56.default.func, import_prop_types56.default.object]),
  ...
  slots: import_prop_types56.default.shape({
    ...
    switchBase: import_prop_types56.default.elementType,
...
var ButtonGroupContext = React65.createContext({});
if (true) {
...
var ButtonGroupButtonContext = React66.createContext(void 0);
if (true) {
...
var Button = React67.forwardRef(function Button2(inProps, ref) {
  const contextProps = React67.useContext(ButtonGroupContext_default);
  const buttonGroupButtonContextPositionClassName = React67.useContext(ButtonGroupButtonContext_default);
  ...
  const loadingId = useId_default(idProp);
  const loadingIndicator = loadingIndicatorProp ?? (0, import_jsx_runtime56.jsx)(CircularProgress_default, {
    "aria-labelledby": loadingId,
    color: "inherit",
    size: 16
  });
  ...
  const startIcon = (startIconProp || loading && loadingPosition === "start") && (0, import_jsx_runtime56.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp || (0, import_jsx_runtime56.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  const endIcon = (endIconProp || loading && loadingPosition === "end") && (0, import_jsx_runtime56.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp || (0, import_jsx_runtime56.jsx)(ButtonLoadingIconPlaceholder, {
      className: classes.loadingIconPlaceholder,
      ownerState
    })
  });
  ...
  const loader = typeof loading === "boolean" ? (
    ...
    (0, import_jsx_runtime56.jsx)("span", {
      ...
      children: loading && (0, import_jsx_runtime56.jsx)(ButtonLoadingIndicator, {
        className: classes.loadingIndicator,
        ownerState,
  ...
  return (0, import_jsx_runtime56.jsxs)(ButtonRoot, {
    ownerState,
...
true ? Button.propTypes = {
   ...
   * @default <CircularProgress color="inherit" size={16} />
   */
  loadingIndicator: import_prop_types57.default.node,
  /**
   * The loading indicator can be positioned on the start, end, or the center of the button.
   * @default 'center'
   */
  loadingPosition: import_prop_types57.default.oneOf(["center", "end", "start"]),
  /**
   * The size of the component.
   * `small` is equivalent to the dense button styling.
   * @default 'medium'
...
var InputAdornment = React68.forwardRef(function InputAdornment2(inProps, ref) {
  ...
  return (0, import_jsx_runtime57.jsx)(FormControlContext_default.Provider, {
    value: null,
    children: (0, import_jsx_runtime57.jsx)(InputAdornmentRoot, {
      as: component,
      ownerState,
      className: clsx_default(classes.root, className),
      ref,
      ...other,
      children: typeof children2 === "string" && !disableTypography ? (0, import_jsx_runtime57.jsx)(Typography_default, {
        color: "textSecondary",
        children: children2
      }) : (0, import_jsx_runtime57.jsxs)(React68.Fragment, {
        children: [position === "start" ? (
          /* notranslate needed while Google Translate will not fix zero-width space issue */
          _span4 || (_span4 = (0, import_jsx_runtime57.jsx)("span", {
            className: "notranslate",
            "aria-hidden": true,
            children: "​"
          }))
...
var Tooltip = React69.forwardRef(function Tooltip2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTooltip"
  });
  ...
  const children2 = React69.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime58.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  const isRtl = useRtl();
  ...
  React69.useEffect(() => stopTouchInteraction, [stopTouchInteraction]);
  const handleOpen = (event) => {
  ...
  return (0, import_jsx_runtime58.jsxs)(React69.Fragment, {
    children: [React69.cloneElement(children2, childrenProps), (0, import_jsx_runtime58.jsx)(PopperSlot, {
...
true ? Tooltip.propTypes = {
  ...
  slotProps: import_prop_types59.default.shape({
    arrow: import_prop_types59.default.oneOfType([import_prop_types59.default.func, import_prop_types59.default.object]),
    popper: import_prop_types59.default.oneOfType([import_prop_types59.default.func, import_prop_types59.default.object]),
    tooltip: import_prop_types59.default.oneOfType([import_prop_types59.default.func, import_prop_types59.default.object]),
...
var TableContext = React70.createContext();
if (true) {
...
var TableCell = React72.forwardRef(function TableCell2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTableCell"
  });
  ...
  const table = React72.useContext(TableContext_default);
  const tablelvl2 = React72.useContext(Tablelvl2Context_default);
...
var TablePaginationActions = React74.forwardRef(function TablePaginationActions2(inProps, ref) {
  ...
  return (0, import_jsx_runtime65.jsxs)(TablePaginationActionsRoot, {
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
true ? TablePagination.propTypes = {
  ...
  slotProps: import_prop_types63.default.shape({
    actions: import_prop_types63.default.shape({
      ...
      firstButtonIcon: import_prop_types63.default.object,
      lastButton: import_prop_types63.default.object,
      lastButtonIcon: import_prop_types63.default.object,
      nextButton: import_prop_types63.default.object,
      nextButtonIcon: import_prop_types63.default.object,
      previousButton: import_prop_types63.default.object,
      previousButtonIcon: import_prop_types63.default.object
    }),
  ...
  slots: import_prop_types63.default.shape({
    actions: import_prop_types63.default.shape({
      firstButton: import_prop_types63.default.elementType,
      firstButtonIcon: import_prop_types63.default.elementType,
      lastButton: import_prop_types63.default.elementType,
      lastButtonIcon: import_prop_types63.default.elementType,
      nextButton: import_prop_types63.default.elementType,
      nextButtonIcon: import_prop_types63.default.elementType,
      previousButton: import_prop_types63.default.elementType,
      previousButtonIcon: import_prop_types63.default.elementType
    }),
...
function ClickAwayListener(props) {
  ...
  const movedRef = React76.useRef(false);
  const nodeRef = React76.useRef(null);
  const activatedRef = React76.useRef(false);
  const syntheticEventRef = React76.useRef(false);
  React76.useEffect(() => {
    setTimeout(() => {
  ...
  return React76.cloneElement(children2, childrenProps);
}
true ? ClickAwayListener.propTypes = {
   ...
   */
  onClickAway: import_prop_types64.default.func.isRequired,
  /**
...
var Skeleton = React77.forwardRef(function Skeleton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime67.jsx)(SkeletonRoot, {
    as: component,
    ref,
    className: clsx_default(classes.root, className),
    ownerState,
...
var TabScrollButton = React78.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime68.jsx)(TabScrollButtonRoot, {
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime68.jsx)(StartButtonIcon, {
      ...startButtonIconProps
    }) : (0, import_jsx_runtime68.jsx)(EndButtonIcon, {
      ...endButtonIconProps
    })
  });
});
true ? TabScrollButton.propTypes = {
   ...
   */
  direction: import_prop_types66.default.oneOf(["left", "right"]).isRequired,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   */
  orientation: import_prop_types66.default.oneOf(["horizontal", "vertical"]).isRequired,
  /**
   * The extra props for the slot components.
   * You can override the existing props or add new ones.
   * @default {}
...
function ScrollbarSize(props) {
  ...
  const scrollbarHeight = React79.useRef();
...
var Tabs = React80.forwardRef(function Tabs2(inProps, ref) {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime70.jsx)(ScrollbarSlot, {
      ...scrollbarSlotProps,
      onChange: handleScrollbarSizeChange
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime70.jsx)(ScrollButtonsSlot, {
      direction: isRtl ? "right" : "left",
      onClick: handleStartScrollClick,
      disabled: !displayStartScroll,
      ...scrollButtonSlotProps
    }) : null;
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime70.jsx)(ScrollButtonsSlot, {
  ...
  const indicator = (0, import_jsx_runtime70.jsx)(IndicatorSlot, {
    ...indicatorSlotProps
  });
  let childIndex = 0;
  const children2 = React80.Children.map(childrenProp, (child) => {
  ...
  return (0, import_jsx_runtime70.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime70.jsxs)(ScrollerSlot, {
      ...scrollerSlotProps,
      children: [(0, import_jsx_runtime70.jsx)(ListSlot, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
true ? Tabs.propTypes = {
  ...
  slotProps: import_prop_types68.default.shape({
    ...
    list: import_prop_types68.default.oneOfType([import_prop_types68.default.func, import_prop_types68.default.object]),
    root: import_prop_types68.default.oneOfType([import_prop_types68.default.func, import_prop_types68.default.object]),
    scrollbar: import_prop_types68.default.oneOfType([import_prop_types68.default.func, import_prop_types68.default.object]),
    scrollButtons: import_prop_types68.default.oneOfType([import_prop_types68.default.func, import_prop_types68.default.object]),
    scroller: import_prop_types68.default.oneOfType([import_prop_types68.default.func, import_prop_types68.default.object]),
  ...
  slots: import_prop_types68.default.shape({
    ...
    EndScrollButtonIcon: import_prop_types68.default.elementType,
    indicator: import_prop_types68.default.elementType,
    list: import_prop_types68.default.elementType,
    root: import_prop_types68.default.elementType,
    scrollbar: import_prop_types68.default.elementType,
    scrollButtons: import_prop_types68.default.elementType,
    scroller: import_prop_types68.default.elementType,
...
var Tab = React81.forwardRef(function Tab2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  const icon = iconProp && label && React81.isValidElement(iconProp) ? React81.cloneElement(iconProp, {
    className: clsx_default(classes.icon, iconProp.props.className)
  }) : iconProp;
  const handleClick = (event) => {
  ...
  return (0, import_jsx_runtime71.jsxs)(TabRoot, {
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime71.jsxs)(React81.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime71.jsxs)(React81.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
...
var ToggleButtonGroupContext = React82.createContext({});
if (true) {
...
var ToggleButtonGroupButtonContext = React83.createContext(void 0);
if (true) {
...
var ToggleButton = React84.forwardRef(function ToggleButton2(inProps, ref) {
  const {
    value: contextValue,
    ...contextProps
  } = React84.useContext(ToggleButtonGroupContext_default);
  const toggleButtonGroupButtonContextPositionClassName = React84.useContext(ToggleButtonGroupButtonContext_default);
  ...
  return (0, import_jsx_runtime72.jsx)(ToggleButtonRoot, {
    className: clsx_default(contextProps.className, classes.root, className, positionClassName),
    disabled,
    focusRipple: !disableFocusRipple,
    ref,
...
//# sourceMappingURL=chunk-FPFYL7FG.js.map
